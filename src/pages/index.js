...
export default function Home() {
  return (
    <div className="min-h-screen px-4 md:px-8 lg:px-16 dark:bg-slate-900 flex items-center justify-center">
      <div className="w-full max-w-lg relative">
        ...
        <div className="lg:m-8 relative space-y-4">
          <div className="p-5 lg:p-8 bg-opacity-90 bg-white text-teal-800 dark:bg-slate-800 dark:text-sky-100 rounded-lg flex items-center justify-center">
            <div className="flex-0 font-bold text-2xl sm:text-3xl md:text-4xl ">
